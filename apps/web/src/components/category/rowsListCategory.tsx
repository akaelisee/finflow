...
const RowsListCategory = ({ categoryLists }:Props) => {
    ...
    return(
      <div className="my-7">
        ...
        <div className="grid grid-cols-1 gap-4  md:grid-cols-4">
          ...
          {
            listCategorySysteme.map((personal) => (
          ...
          <div className="flex flex-col items-center justify-center bg-[#f9f8f4] border border-dashed rounded-md p-8">
          ...
          <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-3">
            {
              listCategoryPersonalized.slice(0, btnAll).map((personal) => (
                <div className="flex flex-col gap-3 bg-white border rounded-md p-4">
                  <div className="flex justify-between">
                    <div className="">
                      <CategoryBadge badges={personal}/>
