...
const AlertDrop = ({ onColors, onSelectedColor }:Props) => {

    return (
       <div
      className="fixed inset-0 bg-gray-500/75 transition-opacity"
    >
        <div className="h-full flex items-center justify-center ml-20 lg:ml-72">
            ...
            <div className="bg-white rounded-lg">
                ...
                <div className="mt-3 px-4 py-1 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <div className="mt-2">
                    <p className="text-sm text-gray-500">
                        Are you sure you want to delete{" "}
                        <span className="font-bold"></span>? This
                        action cannot be undone.
                    </p>
                    </div>
                </div>
                <div className=" rounded-b-lg bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <button
